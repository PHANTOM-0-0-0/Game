...
while True:
    ...
    if lt in lt_old:
        ...
        # Добавляем букву во множество введенных.
        lt_old.add(lt)
    ...
    if not flag:
        ...
        # Введенная буква есть в слове, одна или несколько.

        # Меняем в строке для вывода все заглушки на угаданную букву
...
if flag_word:
    # Угадали слово, сразу или по буквам
    print()
    print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
    print('▲ Победа! Угадали слово: <<', word, '>> с ', ntr, ' попыток!' )
    print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
else:
    # Не угадали, но выходим из игры.
    print()
    print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
